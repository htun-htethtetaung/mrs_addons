...
class AppointmentOnboardingLink(models.TransientModel):
    ...
    appointment_type_id = fields.Many2one(
        "appointment.type", required=True, readonly=True, ondelete="cascade"
    )
    ...
    def search_or_create_onboarding_invite(self):
        ...
        validation_response = self.env[
            "onboarding.onboarding.step"
        ].action_validate_step("appointment.appointment_onboarding_preview_invite_step")
