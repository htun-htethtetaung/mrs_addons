        ...
        for (
            ...
            with self.subTest(
                ...
                for recipient in invite_recipients:
                    invitation_mails |= self.assertMailMail(
                        recipient, "outgoing", author=self.staff_user_bxls.partner_id
                    )
                ...
                for recipient in cancel_recipients:
                    cancellation_mails |= self.assertMailMail(
                        recipient, "sent", author=self.staff_user_bxls.partner_id
                    )
