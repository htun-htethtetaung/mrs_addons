...
class AppointmentOnboardingTest(AppointmentCommon):
    ...
    def test_no_error_if_steps_are_deleted(self):
        ...
        """
        appointment_onboarding_panel = self.env.ref(
        ...
        self.assertIn(
            "bookUrl",
            res,
            "search_or_create_onboarding_invite should return a link when step 1 is missing.",
        )
        ...
        self.assertIn(
            "bookUrl",
            res,
            "search_or_create_onboarding_invite should return a link when step 2 is missing.",
        )
