...
class OnboardingStep(models.Model):
    ...
    def action_open_appointment_onboarding_create_appointment_type(self):
        view_id = self.env.ref(
            "appointment.appointment_type_view_form_appointment_onboarding"
        ).id
    ...
    def action_open_appointment_onboarding_preview_invite(self):
        ...
        appointment_type = self.env["appointment.type"].search([], limit=1) or self.env[
            "appointment.type"
        ].create({"name": _("Meet With Me")})
